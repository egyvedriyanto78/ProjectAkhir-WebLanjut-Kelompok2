...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="nav-item dropdown">
            <a href="#" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block"><i class="fa fa-user ms-3"></i>
                Halo,
                <?= user()->username; ?>
            </a>
            <div class="dropdown-menu rounded-0 rounded-bottom m-0">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    <img class="img-fluid rounded w-75 align-self-end"
                        src="<?php echo base_url('landing-page/img/about-1.jpg') ?>" alt="">
                    <img class="img-fluid rounded w-50 bg-white pt-3 pe-3"
                        src="<?php echo base_url('landing-page/img/about-2.jpg') ?>" alt="" style="margin-top: -25%;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <p>Klinik Unila adalah fasilitas kesehatan dibawah naungan Universitas Lampung. Guna menyejahterakan dan
                    menyehatkan warga Universitas Lampung untuk mencapai Unila Sehat!</p>
