...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Form Edit Data Diri Pasien</h1>
            <nav>
                <ol class="breadcrumb">
                ...
                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('dokter/update/' . $pasien['id'])?>" method="post">
                                <?= csrf_field() ?>
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">Full Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="full_name"
                                            value="<?= $pasien['full_name']?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" style="height: 100px"
                                            name="illness"><?= $pasien['illness']?></textarea>
                                    </div>
                                </div>
