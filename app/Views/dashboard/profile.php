                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src=<?php echo base_url('dashboard/img/team-2.jpg')?> alt="Profile"
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">dr. Budi, S.ked.</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Company</div>
                                        <div class="col-lg-9 col-md-8">Klink Unila</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Job</div>
                                        <div class="col-lg-9 col-md-8">Dokter Umum</div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">Jl. Kampung Baru, Unila</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Phone</div>
                                        <div class="col-lg-9 col-md-8">(+62) 82274418654</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Email</div>
                                        <div class="col-lg-9 col-md-8">budi123@gmail.com</div>
                                    </div>
                                    ...
                                    <form>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img src=<?php echo base_url('dashboard/img/team-2.jpg')?>
                                                    alt="Profile">
                                                <div class="pt-2">
