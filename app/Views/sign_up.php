  ...
  <div class="container">
    <div class="card">
      <div class="card_title">
        ...
        <span class="subtitle"><?=lang('Auth.alreadyRegistered')?> <a href="<?= url_to('login') ?>"><?=lang('Auth.signIn')?></a></span>        
      </div>
      ...
      <div class="input-control">
        ...
        <button type="submit" class="btn-signup"><?=lang('Auth.register')?></button>        
      </form>  
      </div>    
    </div>
  </div>
